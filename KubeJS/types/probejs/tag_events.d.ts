...
declare namespace TagEvent {
    ...
    class FuelType extends Internal.TagEventJS {
    get(id: Special.FuelTypeTag): Internal.TagWrapper
    add(tag: Special.FuelTypeTag, ...id: Special.FuelType[]): Internal.TagWrapper
    remove(tag: Special.FuelTypeTag, ...id: Special.FuelType[]): Internal.TagWrapper
    removeAll(tag: Special.FuelTypeTag): Internal.TagWrapper
    removeAllTagsFrom(...id: Special.FuelType[]): Internal.TagWrapper
    }
