...
declare const CEncasedEvents: {
    /**
     * @at *startup*
    */
registerSets(handler: (event: Internal.RegisterSetsEvent) => void):void,
};
...
registry(type: "createdieselgenerators:fuel_type", handler: (event: Registry.FuelType) => void):void,
...
declare const CDGEvents: {
    /**
     * @at *client*
    */
lighterSkins(handler: (event: Internal.LighterSkinsEventJS) => void):void,
    /**
     * @at *startup*
    */
molds(handler: (event: Internal.MoldEventJS) => void):void,
    /**
     * @at *server*
     * 
     * @cancellable
    */
oilAmount(handler: (event: Internal.GetChunkOilAmountEventJS) => void):void,
};
